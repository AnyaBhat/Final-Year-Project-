...
model_path = 'D:\Final_year_project - Copy\Model\kannada_training.h5'
...
def predict():
    try:
        ...
        # Get the predicted class and confidence level for the image
        ...
        # Return the predicted class, character, and confidence level as JSON
        return jsonify({
